	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage        : /*'~/Scripts/jquery-progressbar/*/ base + 'Scripts/jquery-progressbar/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
				    0: base + 'Scripts/jquery-progressbar/images/progressbg_black.gif'
				    //30: base + 'Scripts/jquery-progressbar/images/progressbg_orange.gif',
				    //70: base + 'Scripts/jquery-progressbar/images/progressbg_red.gif'
								},
